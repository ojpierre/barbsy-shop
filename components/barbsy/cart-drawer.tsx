                    ...
                    <div className="flex items-center gap-3">
                      <div className="flex items-center border border-border rounded-full">
                        <button
                          ...
                          className="p-1.5 hover:bg-muted barbsy-transition rounded-l-full"
                        ...
                        <button
                          type="button"
                          onClick={() => updateQuantity(item.id, item.quantity + 1)}
                          className="p-1.5 hover:bg-muted barbsy-transition rounded-r-full"
                      ...
                      <button
                        ...
                        className="p-1.5 text-muted-foreground hover:text-destructive barbsy-transition"
        ...
        {items.length > 0 && (
          <DrawerFooter className="border-t border-border/50 p-6 gap-4">
            ...
            <DrawerClose asChild>
              <button
                type="button"
                className="w-full border border-border text-foreground py-4 rounded-full font-medium hover:bg-muted barbsy-transition"
              >
                Continue Shopping
              </button>
            </DrawerClose>
